...
//     { nombre: 'do', sonido: './wav/c2.wav', tono: true },
//  ];
 
$.ajax({
    url: 'http://www.mocky.io/v2/5bd88688310000743a474efb',
}).done(function (notasFromServer) {
    console.log(notasFromServer);
    generateStructure(notasFromServer, 'piano')
})
 ...
 function generateStructure(arrNotes, divN) {
    ...
    arrNotes.forEach(element => {
        ...
        `<div class="note" data-snd="${element.sonido}"></div>` :
